...
var Court;Court={init:function(t,e){return this.net_jump=10,this.net_y=this.net_jump,this.net_width=5,this.net_step_length=10,this.gameW=t,this.gameH=e},render:function(){var t,e;for(t=this.net_y,e=[];t<this.gameH;)Engine.ctx.fillStyle="#fff",Engine.ctx.fillRect(this.gameW/2-this.net_width,t,this.net_width,this.net_step_length),e.push(t+=this.net_step_length+this.net_jump);return e}};
